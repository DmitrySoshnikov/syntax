/**
 * Start conditions of lex rules. Tokenizer states. Ruby version.
 *
...

{
  "moduleInclude": `
    ...
    YYParse.on_parse_end {|_value|
      puts 'Number of lines: ' + $lines.to_s
    }
  ...
  "lex": {
    ...
    "rules": [
      ...
      [["comment"], "\\n", `
        $lines += 1
        return nil                                # skip new lines in comments
      `],

      // In INITIAL state, count line numbers as well:
      ["\\n", `
        $lines += 1
        return nil                                # skip new lines`],
